...
function AnisotropicMatern(;
    ...
    return AnisotropicMatern{T,N}(length_scale, output_scale, smoothness)
end
...
function derivative_weights(p::AnisotropicMatern, dimension)
    return ntuple(n -> p.length_scale[n]^2, dimension)
end
